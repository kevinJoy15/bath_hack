...
const PromptBar = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            console.log('About to call postDream');
            const postDreamResponse = await postDream({
                userId: 1,
                dreamDescription: searchText
            });
    
            setDreamData({
                title: postDreamResponse.header.title,
                author: 'Diya Vibhakar',
                story: postDreamResponse.story
            });
        } catch (error) {
